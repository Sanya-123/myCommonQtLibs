...
static const QString orangeSS = QString("color: white;border-radius: %1;background-color: qlineargradient(spread:pad, x1:0.232, y1:0.272, x2:0.98, y2:0.959773, stop:0 rgba(255, 160, 4, 255), stop:1 rgba(91, 41, 7, 255))").arg(SIZE/2);
...
void LedLabel::setState(State state)
{
    switch(state){
        case StateOk:
...
void LedLabel::setState(bool state)
{
